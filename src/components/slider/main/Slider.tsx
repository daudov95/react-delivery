    ...
    return (
        <div className="main-slider">
            <div ref={prevRef} className="swiper-button-prev">
                <svg width="14" height="22" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="m4.833 11 8.333-8.334L11.083.583.667 11l10.416 10.417 2.083-2.083L4.833 11Z" fill="#212121"/></svg>
            </div>
            <div ref={nextRef} className="swiper-button-next">
                <svg width="14" height="22" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M9.167 11 .833 2.666 2.917.583 13.334 11 2.917 21.417.833 19.334 9.167 11Z" fill="#212121"/></svg>
            </div>
