...
import { IRestaurant } from "../restaurant/main/Restaurant";
                    ...
                    <div className="store">
                        <div className="store__left">
                            <div
                                ...
                                style={{
                                    backgroundImage:
                                        "url('./assets/img/store/banner.jpg')",
                                }}
                            >
                                <a href="#" className="store-banner__back">
                                    Все рестораны
                                </a>

                                <div className="store-banner__block">
                                    <h1 className="store-banner__title">
                                        Точка
                                    </h1>
                                ...
                                <div className="store-posts__list">
                                    <div className="store-item">
                                        ...
                                        <div className="store-item__info">
                                            <h3 className="store-item__title">
                                                Чизбургер
                                            </h3>
                                            <p className="store-item__desc">
                                                Вкусные, обжаренные в
                                                растительном фритюре и сле...
                                            </p>
